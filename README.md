...
If the output is a version that meets the mimimum required version, you can skip the remainder of this Dependencies section and proceed directly to the [installation](#installation) of `abtab`; if it is a version that does not meet the mimimum required version, you must update the software as described in [Step 2](#2-installing-or-updating-python-and-java) and proceed from there.
